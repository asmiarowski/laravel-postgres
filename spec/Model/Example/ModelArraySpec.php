...
class ModelArraySpec extends ObjectBehavior
{
    ...
    {
        $this->accessPgArray('{0,1,2}')->shouldReturn([0,1,2]);
    ...
    {
        $this->mutateToPgArray(['a' => 0, 'b' => 1, 'c' => 2])->shouldReturn('{0,1,2}');
        $this->mutateToPgArray(['a' => ['x' => 0, 'y' => 1], 'b' => ['x' => 2, 'y' => 3]])->shouldReturn('{{0,1},{2,3}}');
    }
}
